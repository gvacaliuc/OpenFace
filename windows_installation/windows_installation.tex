...
\newthought{To get a C/C++ compiler}, we'll install either the MSVC 2015 Build 
...
from the URL to the right, making sure to download the *.zip. \\
    ...
    \newthought{To build} our libraries, open an ``x64 Native Tools Command Prompt for VS 2015/17''
...
\subsection{libpng}
    ...
    \newthought{To build} libpng, either open an ``x64 Native Tools Command Prompt for VS 2015/17''
...
\subsection{libjpeg}
    ...
    \newthought{To download and build}, execute the following in an ``x64 Native Tools Command
