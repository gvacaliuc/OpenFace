...
from the URL to the right, making sure to download the *.zip. \\
    ...
    \newthought{To build} our libraries, open an ``x64 Native Tools Command Prompt for VS 2017''
...
\subsection{libpng}
    ...
    \newthought{To build} libpng, either open an ``x64 Native Tools Command Prompt for VS 2017''
